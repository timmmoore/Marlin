...
// Auto fans
#define HAS_AUTO_NOPS_FAN_0 (HOTENDS > 0 && PIN_EXISTS(E0_AUTO_FAN))
#define HAS_AUTO_NOPS_FAN_1 (HOTENDS > 1 && PIN_EXISTS(E1_AUTO_FAN))
#define HAS_AUTO_NOPS_FAN_2 (HOTENDS > 2 && PIN_EXISTS(E2_AUTO_FAN))
#define HAS_AUTO_NOPS_FAN_3 (HOTENDS > 3 && PIN_EXISTS(E3_AUTO_FAN))
#define HAS_AUTO_NOPS_FAN_4 (HOTENDS > 4 && PIN_EXISTS(E4_AUTO_FAN))
#define HAS_AUTO_NOPS_FAN_5 (HOTENDS > 5 && PIN_EXISTS(E5_AUTO_FAN))
#define HAS_AUTO_FAN_0 (HAS_AUTO_NOPS_FAN_0 && !ENABLED(AUTO_POWER_E_COOLING))
#define HAS_AUTO_FAN_1 (HAS_AUTO_NOPS_FAN_1 && !ENABLED(AUTO_POWER_E_COOLING))
#define HAS_AUTO_FAN_2 (HAS_AUTO_NOPS_FAN_2 && !ENABLED(AUTO_POWER_E_COOLING))
#define HAS_AUTO_FAN_3 (HAS_AUTO_NOPS_FAN_3 && !ENABLED(AUTO_POWER_E_COOLING))
#define HAS_AUTO_FAN_4 (HAS_AUTO_NOPS_FAN_4 && !ENABLED(AUTO_POWER_E_COOLING))
#define HAS_AUTO_FAN_5 (HAS_AUTO_NOPS_FAN_5 && !ENABLED(AUTO_POWER_E_COOLING))
#define HAS_AUTO_E_FAN (HAS_AUTO_NOPS_FAN_0 || HAS_AUTO_NOPS_FAN_1 || HAS_AUTO_NOPS_FAN_2 || HAS_AUTO_NOPS_FAN_3 || HAS_AUTO_NOPS_FAN_4 || HAS_AUTO_NOPS_FAN_5)
#define HAS_AUTO_CHAMBER_NOPS_FAN (HAS_TEMP_CHAMBER && PIN_EXISTS(CHAMBER_AUTO_FAN))
#define HAS_AUTO_CHAMBER_FAN HAS_AUTO_CHAMBER_NOPS_FAN && !ENABLED(AUTO_POWER_C_COOLING)
#define HAS_AUTO_FAN (HAS_AUTO_E_FAN || HAS_AUTO_CHAMBER_NOPS_FAN)
...
#define HAS_CONTROLLER_FAN (PIN_EXISTS(CONTROLLER_FAN) && !ENABLED(AUTO_POWER_CONTROLLER_COOLING))
...
// Disable auto power control options for missing fans
  ...
  #endif
  #if DISABLED(USE_CONTROLLER_FAN)

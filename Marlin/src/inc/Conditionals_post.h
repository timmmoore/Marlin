...
#define HAS_AUTO_E_FAN (HAS_AUTO_FAN_0 || HAS_AUTO_FAN_1 || HAS_AUTO_FAN_2 || HAS_AUTO_FAN_3 || HAS_AUTO_FAN_4 || HAS_AUTO_FAN_5)
...
#define HAS_AUTO_PIN_FAN_0 HAS_AUTO_FAN_0 && (E0_AUTO_FAN_PIN != PS_ON_PIN)
#define HAS_AUTO_PIN_FAN_1 HAS_AUTO_FAN_1 && (E1_AUTO_FAN_PIN != PS_ON_PIN)
#define HAS_AUTO_PIN_FAN_2 HAS_AUTO_FAN_2 && (E2_AUTO_FAN_PIN != PS_ON_PIN)
#define HAS_AUTO_PIN_FAN_3 HAS_AUTO_FAN_3 && (E3_AUTO_FAN_PIN != PS_ON_PIN)
#define HAS_AUTO_PIN_FAN_4 HAS_AUTO_FAN_4 && (E4_AUTO_FAN_PIN != PS_ON_PIN)
#define HAS_AUTO_PIN_FAN_5 HAS_AUTO_FAN_5 && (E5_AUTO_FAN_PIN != PS_ON_PIN)

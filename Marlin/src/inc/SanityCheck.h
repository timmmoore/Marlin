 ...
 */
  ...
  #if !PIN_EXISTS(CONTROLLER_FAN) && !ENABLED(AUTO_POWER_CONTROLLER_COOLING)
    #error "USE_CONTROLLER_FAN requires a CONTROLLER_FAN_PIN. Define in Configuration_adv.h."
  #elif (E0_AUTO_FAN_PIN == CONTROLLER_FAN_PIN) && PIN_EXISTS(CONTROLLER_FAN)
    #error "You cannot set E0_AUTO_FAN_PIN equal to CONTROLLER_FAN_PIN."
  #elif (E1_AUTO_FAN_PIN == CONTROLLER_FAN_PIN) && PIN_EXISTS(CONTROLLER_FAN)
    #error "You cannot set E1_AUTO_FAN_PIN equal to CONTROLLER_FAN_PIN."
  #elif (E2_AUTO_FAN_PIN == CONTROLLER_FAN_PIN) && PIN_EXISTS(CONTROLLER_FAN)
    #error "You cannot set E2_AUTO_FAN_PIN equal to CONTROLLER_FAN_PIN."
  #elif (E3_AUTO_FAN_PIN == CONTROLLER_FAN_PIN) && PIN_EXISTS(CONTROLLER_FAN)
